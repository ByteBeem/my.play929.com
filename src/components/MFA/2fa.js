    ...
    <div style={pageStyles}>
      <div style={containerStyles}>
        <div style={leftPanelStyles}>
          ...
          <p style={subtitleStyles}>Your security is our priority – Please check your authentication app.</p>
        </div>
        <div style={rightPanelStyles}>
          <form onSubmit={handleSubmit} style={formStyles}>
            <h1 style={headerStyles}>
              Two Factor Authentication enabled: Enter the code from your authentication app
            </h1>
